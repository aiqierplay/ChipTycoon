...
public class UIRunnerProgress : UIBase
{
    ...
    public void Update()
    {
        ...
        TextPoint.text = App.Player.State.Point.ToString();
        TextPoint.color = App.Player.Data.Color;

        var factor = Player.Move.LevelPathFollower.Factor;
