...
[EditorTool]
public class EditorToolBuildInEditorIconPreview : EditorToolBase
{
    public override string GetTitle() => "Build-In Res/Unity EditorIcon Preview";
    ...
    protected GUIContent GetIcon(string iconName)
    {
    ...
    {
        var allIcons = IcoList.Where(x => GetIcon(x) != null);
    ...
    public void DrawGui()
    {
        ...
        using (new GUILayout.HorizontalScope(EditorStyles.helpBox, GUILayout.MaxHeight(_viewBigIcons ? 140 : 120)))
        {
            ...
            using (new GUILayout.VerticalScope())
            {
                ...
                EditorGUILayout.TextField("EditorGUIUtility.FindTexture(\"" + _iconSelected.tooltip + "\")");
                GUILayout.Space(5);
    ...
    [NonSerialized] public static List<string> IconMissingNames;
    ...
    protected void AllTheTextures(ref GUIStyle style, Texture2D texture)
    {
        style.hover.background = style.onHover.background = style.focused.background = style.onFocused.background =
        ...
        style.hover.scaledBackgrounds = style.onHover.scaledBackgrounds = style.focused.scaledBackgrounds =
            style.onFocused.scaledBackgrounds = style.active.scaledBackgrounds = style.onActive.scaledBackgrounds =
                style.normal.scaledBackgrounds = style.onNormal.scaledBackgrounds = new Texture2D[] { texture };
    }

    protected Texture2D Texture2DPixel(Color c)
    {
