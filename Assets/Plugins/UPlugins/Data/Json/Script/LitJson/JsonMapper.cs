...
namespace Aya.Data.Json
{
    ...
    public class JsonMapper
    {
        ...
        private static void RegisterBaseExporters()
        {
            ...
            // Vector2Int
            BaseExportersTable[typeof(Vector2Int)] = (obj, writer) =>
            {
            ...
            // Vector3Int
            BaseExportersTable[typeof(Vector3Int)] = (obj, writer) =>
            {
        ...
        private static void RegisterBaseImporters()
        {
            ...
            {
                var strs = ((string)input).Split(',');
                var x = Convert.ToInt32(strs[0]);
                var y = Convert.ToInt32(strs[1]);
                var value = new Vector2Int(x, y);
                return value;
            };
            RegisterImporter(BaseImportersTable, typeof(string), typeof(Vector2Int), importer);
            // Vector3Int
            importer = input =>
            {
                var strs = ((string)input).Split(',');
                var x = Convert.ToInt32(strs[0]);
                var y = Convert.ToInt32(strs[1]);
                var z = Convert.ToInt32(strs[2]);
                var value = new Vector3Int(x, y, z);
                return value;
            };
            RegisterImporter(BaseImportersTable, typeof(string), typeof(Vector3Int), importer);
            // Quaternion 
            importer = input =>
            {
                var strs = ((string)input).Split(',');
