...
namespace Aya.Extension
{
    public static partial class AnimatorExtension
    {
        ...
        private static Dictionary<Animator, AnimatorControllerParameter[]> AnimatorParameterDic = new Dictionary<Animator, AnimatorControllerParameter[]>();

        private static AnimatorControllerParameter[] GetAnimatorParameters(Animator animator)
        {
            if (!AnimatorParameterDic.TryGetValue(animator, out var animatorControllerParameters))
            {
                animatorControllerParameters = animator.parameters;
                AnimatorParameterDic.Add(animator, animatorControllerParameters);
            }
