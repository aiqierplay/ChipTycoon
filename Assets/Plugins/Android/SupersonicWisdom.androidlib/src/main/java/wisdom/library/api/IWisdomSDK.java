...
interface IWisdomSDK {
    ...
    void initiateUpdate(Activity activity, int updateType);
    void checkForUpdate();
    void addAppUpdateListener(IWisdomAppUpdateListener listener);
    void removeAppUpdateListener(IWisdomAppUpdateListener listener);
    boolean openApplication(String appIdentifier);
