...
namespace Aya.TweenPro
{
    ...
    public partial class TMPPerCharEffectData
    {
        ...
        public void Cache(TweenAnimation animation, TMP_Text text, ITMPCharacterModifier modifier)
        {
            if (text == null) return;
            Text = text;
            ...
            Effect.SyncModifiers(animation);
        }
        ...
        public int GetStartIndex(int handlerCharacterIndex)
        {
            ...
            if (OrderMode == TextOrderMode.UniformRandom) return Effect.CharacterIndexList[handlerCharacterIndex];
            if (OrderMode == TextOrderMode.SelfRandom) return CharacterIndexList[handlerCharacterIndex];
            return handlerCharacterIndex;
        }

        public void Remove(TweenAnimation animation, TMP_Text text, ITMPCharacterModifier modifier)
        {
            if (text == null) return;
            if (Effect == null) Effect = text.GetComponent<UTweenTMPPerCharEffectHandler>();
    ...
    public partial class TMPPerCharEffectData : ITweenerSubData
    {
