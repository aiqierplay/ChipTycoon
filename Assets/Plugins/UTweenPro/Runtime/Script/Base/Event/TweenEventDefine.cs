...
namespace Aya.TweenPro
{
    ...
    [Serializable]
    public class OnValueVector2IntEvent : UnityEvent<Vector2Int>
    {
    ...
    [Serializable]
    public class OnValueVector3IntEvent : UnityEvent<Vector3Int>
    {
    ...
    [Serializable]
    public class OnValueBoundsEvent : UnityEvent<Bounds>
    {

    }

    [Serializable]
    public class OnValueBoundsIntEvent : UnityEvent<BoundsInt>
    {
    ...
    [Serializable]
    public class OnValueRectIntEvent : UnityEvent<RectInt>
    {
