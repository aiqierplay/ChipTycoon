...
{
    [Tweener("Scale", nameof(Transform), -998)]
    [Serializable]
    ...
    public static partial class UTween
    {
        ...
        public static TweenScale Scale(Transform transform, Transform from, Transform to, float duration)
        {
            var tweener = Play<TweenScale, Transform, Vector3>(transform, from.localScale, to.localScale, duration);
            return tweener;
        }

        public static TweenScale Scale(Transform transform, Transform to, float duration)
        {
            var tweener = Play<TweenScale, Transform, Vector3>(transform, to.localScale, duration)
                .SetCurrent2From() as TweenScale;
            return tweener;
        }
    ...
    public static partial class TransformExtension
    {
        ...
        public static TweenScale TweenScale(this Transform transform, Transform to, float duration)
        {
            var tweener = UTween.Scale(transform, to, duration);
            return tweener;
        }

        public static TweenScale TweenScale(this Transform transform, Transform from, Transform to, float duration)
        {
            var tweener = UTween.Scale(transform, from, to, duration);
            return tweener;
        }
