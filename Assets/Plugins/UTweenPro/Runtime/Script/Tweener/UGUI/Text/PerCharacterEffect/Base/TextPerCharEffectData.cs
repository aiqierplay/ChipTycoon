...
namespace Aya.TweenPro
{
    ...
    public partial class TextPerCharEffectData
    {
        ...
        public void Cache(TweenAnimation animation, Text text, ITextCharacterModifier modifier)
        {
            if (text == null) return;
            Text = text;
        ...
        public void Remove(TweenAnimation animation, Text text, ITextCharacterModifier modifier)
        {
            if (text == null) return;
            if (Effect == null) Effect = text.GetComponent<UTweenPerCharEffectHandler>();
    ...
    public partial class TextPerCharEffectData : ITweenerSubData
    {
