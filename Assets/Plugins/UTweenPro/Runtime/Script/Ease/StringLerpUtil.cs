...
namespace Aya.TweenPro
{
    public static class StringLerpUtil
    {
        ...
        public static string Lerp(string value, float factor, bool richTextEnabled)
        {
            var strLength = GetLength(value, richTextEnabled);
            var length = (int)(factor * strLength);
            return LerpByLength(value, length, richTextEnabled);
        }

        public static string LerpByLength(string value, int length, bool richTextEnabled)
        {
